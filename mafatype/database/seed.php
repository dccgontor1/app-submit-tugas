...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn->connect_error) {
        ...
        $ddls = [
            ...
            "CREATE TABLE Competitions (id INT AUTO_INCREMENT PRIMARY KEY, title VARCHAR(255) NOT NULL, description TEXT, language ENUM('en','id','ar') NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)",
